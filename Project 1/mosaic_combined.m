function [ mosaic ] = mosaic_combined( image1, image2, i1_mask, ...
                                      i1_offset, i2_offset, mode )
%MOSAIC_COMBINED Summary of this function goes here
    i1_size = size(image1);
    i2_size = size(image2);
    
%    i1_mask = ones(i1_size(1), i1_size(2));
    i2_mask = ones(i2_size(1), i2_size(2));
    ...
    mask  (a1:a1+i1_size(1)-1, b1:b1+i1_size(2)-1,:) = ...
      mask(a1:a1+i1_size(1)-1, b1:b1+i1_size(2)-1,:) + i1_mask;
    ...
    mask  (a2:a2+i2_size(1)-1, b2:b2+i2_size(2)-1,:) = ...
      mask(a2:a2+i2_size(1)-1, b2:b2+i2_size(2)-1,:) + i2_mask;
